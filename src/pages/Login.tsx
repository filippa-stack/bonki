              ...
              {otpSent ? (
                ...
                >
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full flex items-center justify-center gap-2 border-0 disabled:opacity-50"
                    style={{
                      height: 44,
                      borderRadius: 22,
                      background: '#E85D2C',
              ...
              >
                ...
                {isNative && (
                  <button
                    ...
                    className="w-full h-14 text-base font-semibold rounded-xl flex items-center justify-center gap-2 disabled:opacity-50"
                    style={{
                      background: '#FFFFFF',
                      color: '#1F1F1F',
