...
const categories: Category[] = [
  ...
  { id: 'vk-utanfor-hemmet', title: 'Livet utanför hemmet', subtitle: 'Aktiviteter, kompisar och att växa upp.', description: 'Aktiviteter, kompisar, tonår och arbete', cardCount: 4 },
];
...
export const vardagskortProduct: ProductManifest = {
  ...
  name: 'Vardag',
  slug: 'vardagskort',
  tagline: 'Det vanliga, på djupet.',
  description: 'Utforska vardagens rutiner och relationer',
  headerTitle: 'Vårt vardagsliv',
  accentColor: 'hsl(187, 42%, 22%)',
  accentColorMuted: 'hsl(92, 18%, 78%)',
  secondaryAccent: 'hsl(92, 22%, 30%)',
  backgroundColor: '#48A873',
  ctaButtonColor: '#8BDDB0',
  tileLight: '#8BDDB0',
  tileMid: '#68C494',
  tileDeep: '#48A873',
  pronounMode: 'du',
