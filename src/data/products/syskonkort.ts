...
export const syskonkortProduct: ProductManifest = {
  ...
  name: 'Syskon',
  slug: 'syskonkort',
  tagline: 'När vi delar allt & inget',
  description: 'Utforska syskonbandet och allt det innebär',
  headerTitle: 'Syskonband',
  accentColor: 'hsl(19, 46%, 38%)',
  accentColorMuted: 'hsl(19, 30%, 82%)',
  secondaryAccent: 'hsl(19, 46%, 38%)',
  backgroundColor: '#8E459D',
  ctaButtonColor: '#CF8BDD',
  tileLight: '#CF8BDD',
  tileMid: '#B56CC4',
  tileDeep: '#8E459D',
  pronounMode: 'du',
