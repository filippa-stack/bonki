...
const categories: Category[] = [
  ...
  { id: 'jiv-vad-tror-jag-pa', title: 'Vad jag tror på', subtitle: 'Värderingar, mening och det som är större än oss.', description: 'Kärlek, sexualitet, moral & etik, frihet, existens och aktivism', cardCount: 6 },
];
