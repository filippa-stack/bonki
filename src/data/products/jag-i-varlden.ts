...
const categories: Category[] = [
  ...
  { id: 'jiv-varlden-omkring-mig', title: 'Världen utanför', subtitle: 'Normer, press och frågor som påverkar oss alla.', description: 'Sociala medier, fördomar, prestation, hälsa och psykisk ohälsa', cardCount: 5 },
...
const cards: Card[] = [
  ...
  qsCard('jiv-sjalvkansla', 'Självkänsla', 'Att tro på sig själv – skillnaden mellan självkänsla, självförtroende och egoism', 'jiv-vem-ar-jag',
  ...
  qsCard('jiv-roller', 'Roller', 'De roller vi tar på oss i olika sammanhang – och om vi alltid är oss själva', 'jiv-vem-ar-jag',
  ...
  qsCard('jiv-sexualitet', 'Sexualitet', 'Normer och förväntningar kring sex -- och varför det är viktigt att prata om', 'jiv-vad-tror-jag-pa',
  ...
  qsCard('jiv-moral-etik', 'Moral & etik', 'Vad som är rätt och fel -- och vem som egentligen bestämmer det', 'jiv-vad-tror-jag-pa',
  ...
  qsCard('jiv-frihet', 'Frihet', 'Vad frihet egentligen innebär – och hur ansvar och frihet hänger ihop', 'jiv-vad-tror-jag-pa',
  ...
  qsCard('jiv-existens', 'Existens', 'De stora frågorna om mening, liv och vad som händer efter döden', 'jiv-vad-tror-jag-pa',
  ...
  qsCard('jiv-aktivism', 'Aktivism', 'Att vilja förändra världen -- och vad som faktiskt gör skillnad', 'jiv-vad-tror-jag-pa',
