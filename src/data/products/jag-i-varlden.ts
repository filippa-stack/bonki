...
const qsCard = (id: string, title: string, catId: string, questions: string[], scenario: string): Card => ({
  id, title, categoryId: catId,
  sections: [
...
const cards: Card[] = [
  // ── K1: Min vardag ──
  qsCard('jiv-halsa', 'Hälsa', 'jiv-min-vardag',
  ...
  qsCard('jiv-prestation', 'Prestation', 'jiv-min-vardag',
  ...
  qsCard('jiv-bekraftelse', 'Bekräftelse', 'jiv-min-vardag',
  ...
  qsCard('jiv-sjalvkansla', 'Självkänsla', 'jiv-min-vardag',
  ...
  // ── K2: Vem jag är ──
  qsCard('jiv-identitet', 'Identitet', 'jiv-vem-jag-ar',
  ...
  qsCard('jiv-roller', 'Roller', 'jiv-vem-jag-ar',
  ...
  qsCard('jiv-frihet', 'Frihet', 'jiv-vem-jag-ar',
  ...
  qsCard('jiv-karlek', 'Kärlek', 'jiv-vem-jag-ar',
  ...
  qsCard('jiv-vanskap', 'Vänskap', 'jiv-vem-jag-ar',
  ...
  // ── K3: Jag & andra ──
  qsCard('jiv-kommunikation', 'Kommunikation', 'jiv-jag-och-andra',
  ...
  qsCard('jiv-konflikt', 'Konflikt', 'jiv-jag-och-andra',
  ...
  qsCard('jiv-medkansla', 'Medkänsla', 'jiv-jag-och-andra',
  ...
  qsCard('jiv-mobbning', 'Mobbning', 'jiv-jag-och-andra',
  ...
  qsCard('jiv-fordomar', 'Fördomar', 'jiv-jag-och-andra',
  ...
  // ── K4: Jag i samhället ──
  qsCard('jiv-social-media', 'Social media', 'jiv-jag-i-samhallet',
  ...
  qsCard('jiv-psykisk-ohalsa', 'Psykisk ohälsa', 'jiv-jag-i-samhallet',
  ...
  qsCard('jiv-sexualitet', 'Sexualitet', 'jiv-jag-i-samhallet',
  ...
  qsCard('jiv-moral-etik', 'Moral & etik', 'jiv-jag-i-samhallet',
  ...
  qsCard('jiv-aktivism', 'Aktivism', 'jiv-jag-i-samhallet',
  ...
  qsCard('jiv-existens', 'Existens', 'jiv-det-stora-sammanhanget',
...
export const jagIVarldenProduct: ProductManifest = {
  ...
  name: 'Jag i Världen',
  slug: 'jag-i-varlden',
  tagline: 'Samtalskort om samhälle och identitet',
