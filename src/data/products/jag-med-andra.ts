...
const cards: Card[] = [
  // ── K1: Att höra till ──
  {
    ...
    sections: [{
      id: 'jma-vanskap-opening', type: 'opening', title: 'Frågor', content: '',
      prompts: [
  ...
  },
  {
    ...
    categoryId: 'jma-att-hora-till',
    sections: [{
      id: 'jma-kontakt-opening', type: 'opening', title: 'Frågor', content: '',
      prompts: [
  ...
  },
  {
    ...
    categoryId: 'jma-att-hora-till',
    sections: [{
      id: 'jma-annorlunda-opening', type: 'opening', title: 'Frågor', content: '',
      prompts: [
  ...
  },
  {
    ...
    categoryId: 'jma-att-hora-till',
    sections: [{
      id: 'jma-utanfor-opening', type: 'opening', title: 'Frågor', content: '',
      prompts: [
  ...
  // ── K2: När vi jämför oss ──
  {
    ...
    sections: [{
      id: 'jma-duktig-opening', type: 'opening', title: 'Frågor', content: '',
      prompts: [
  ...
  },
  {
    ...
    categoryId: 'jma-nar-vi-jamfor-oss',
    sections: [{
      id: 'jma-tavla-opening', type: 'opening', title: 'Frågor', content: '',
      prompts: [
  ...
  },
  {
    ...
    categoryId: 'jma-nar-vi-jamfor-oss',
    sections: [{
      id: 'jma-utseende-opening', type: 'opening', title: 'Frågor', content: '',
      prompts: [
  ...
  },
  {
    ...
    categoryId: 'jma-nar-vi-jamfor-oss',
    sections: [{
      id: 'jma-avund-opening', type: 'opening', title: 'Frågor', content: '',
      prompts: [
  ...
  // ── K3: När det skaver ──
  {
    ...
    sections: [{
      id: 'jma-konflikt-opening', type: 'opening', title: 'Frågor', content: '',
      prompts: [
  ...
  },
  {
    ...
    categoryId: 'jma-nar-det-skaver',
    sections: [{
      id: 'jma-misslyckas-opening', type: 'opening', title: 'Frågor', content: '',
      prompts: [
  ...
  },
  {
    ...
    categoryId: 'jma-nar-det-skaver',
    sections: [{
      id: 'jma-kritik-opening', type: 'opening', title: 'Frågor', content: '',
      prompts: [
  ...
  },
  {
    ...
    categoryId: 'jma-nar-det-skaver',
    sections: [{
      id: 'jma-skam-opening', type: 'opening', title: 'Frågor', content: '',
      prompts: [
  ...
  },
  {
    ...
    categoryId: 'jma-nar-det-skaver',
    sections: [{
      id: 'jma-skuld-opening', type: 'opening', title: 'Frågor', content: '',
      prompts: [
  ...
  // ── K4: Att stå stadig ──
  {
    ...
    sections: [{
      id: 'jma-stopp-opening', type: 'opening', title: 'Frågor', content: '',
      prompts: [
  ...
  },
  {
    ...
    categoryId: 'jma-att-sta-stadig',
    sections: [{
      id: 'jma-integritet-opening', type: 'opening', title: 'Frågor', content: '',
      prompts: [
  ...
  },
  {
    ...
    categoryId: 'jma-att-sta-stadig',
    sections: [{
      id: 'jma-modig-opening', type: 'opening', title: 'Frågor', content: '',
      prompts: [
  ...
  // ── K5: Vi i världen ──
  {
    ...
    sections: [{
      id: 'jma-respekt-opening', type: 'opening', title: 'Frågor', content: '',
      prompts: [
  ...
  },
  {
    ...
    categoryId: 'jma-vi-i-varlden',
    sections: [{
      id: 'jma-lika-varde-opening', type: 'opening', title: 'Frågor', content: '',
      prompts: [
  ...
  },
  {
    ...
    categoryId: 'jma-vi-i-varlden',
    sections: [{
      id: 'jma-sanning-opening', type: 'opening', title: 'Frågor', content: '',
      prompts: [
  ...
  },
  {
    ...
    categoryId: 'jma-vi-i-varlden',
    sections: [{
      id: 'jma-acceptans-opening', type: 'opening', title: 'Frågor', content: '',
      prompts: [
  ...
  },
  {
    ...
    categoryId: 'jma-vi-i-varlden',
    sections: [{
      id: 'jma-kluringen-opening', type: 'opening', title: 'Frågor', content: '',
      prompts: [
