...
const CREATURE_TILE_STYLES: CreatureTileStyle[] = [
  ...
  { scale: 1.15, objectPosition: '50% 18%', opacity: 0.55 },
  { scale: 1.1,  objectPosition: '50% 20%', opacity: 0.50 },
  { scale: 1.1,  objectPosition: '50% 18%', opacity: 0.45 },
  { scale: 1.1,  objectPosition: '50% 20%', opacity: 0.40 },
];
    ...
    <div className="min-h-screen relative overflow-hidden" style={{ backgroundColor: BG }}>
      ...
      >
        ...
        <div style={{
          ...
          background: `linear-gradient(to top, ${BG} 0%, ${BG}F5 15%, rgba(26,26,46,0.88) 30%, rgba(45,110,58,0.45) 55%, rgba(45,110,58,0.15) 75%, transparent 100%)`,
          pointerEvents: 'none',
        }} />
      </motion.div>
