...
import creatureImage from '@/assets/creature-uggla.png';
    ...
    <div className="min-h-screen relative overflow-hidden" style={{ backgroundColor: BG }}>
      ...
      >
        ...
        <div style={{
          ...
          background: `linear-gradient(to top, ${BG} 0%, ${BG}F2 18%, rgba(26,26,46,0.85) 35%, rgba(58,14,88,0.5) 60%, rgba(58,14,88,0.15) 80%, transparent 100%)`,
          pointerEvents: 'none',
        }} />
      </motion.div>
