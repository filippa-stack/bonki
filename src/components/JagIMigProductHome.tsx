...
const ORDERED_TILES = [
  { id: 'jim-mina-kanslor', bg: '#C8D060', text: '#2E3010', sub: 'Att känna igen dem' },
  { id: 'jim-starka-kanslor', bg: '#98A04A', text: '#282E10', sub: 'När det blir mycket' },
  { id: 'jim-stora-kanslor', bg: '#6E7830', text: '#F5F2E8', sub: 'Känslor med många lager' },
];
