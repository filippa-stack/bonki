            ...
            >
              <div
                style={{
                  position: 'relative',
                  borderRadius: '24px',
                  background: `linear-gradient(168deg, ${ACCENT_COLOR}12 0%, ${ACCENT_COLOR}08 50%, ${ACCENT_COLOR}04 100%)`,
                  border: `1.5px solid ${ACCENT_COLOR}30`,
                  boxShadow: [
                    `0 8px 24px -4px ${ACCENT_COLOR}22`,
                    `0 3px 8px ${ACCENT_COLOR}14`,
                    `0 1px 3px rgba(0,0,0,0.04)`,
                    `inset 0 2px 0 rgba(255, 255, 255, 0.5)`,
                    `inset 2px 0 0 rgba(255, 255, 255, 0.15)`,
                    `inset 0 -3px 0 ${ACCENT_COLOR}14`,
                    `inset -2px 0 0 ${ACCENT_COLOR}08`,
                  ].join(', '),
