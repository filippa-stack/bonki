...
export default function BackgroundWatermark() {
  ...
  if (mode === 'hero') {
    return (
      <div className="absolute top-14 left-0 right-0 h-[50vh] pointer-events-none z-0 flex items-center justify-center overflow-hidden" aria-hidden="true">
        <img
          src={bonkiLogo}
          alt=""
          className="w-[70vw] h-[70vw] max-w-[420px] max-h-[420px] object-contain opacity-[0.05] select-none"
          draggable={false}
        />
      </div>
    );
