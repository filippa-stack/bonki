            ...
            return (
              <motion.button
                ...
                style={{
                  ...
                  cursor: 'pointer',
                  border: isHero
                    ? '1.5px solid rgba(77, 144, 142, 0.18)'
                    : '1px solid rgba(77, 144, 142, 0.08)',
                  boxShadow: isHero
                    ? [
                        '0 8px 28px rgba(77, 144, 142, 0.14)',
                        '0 3px 8px rgba(77, 144, 142, 0.07)',
                        'inset 0 2px 0 rgba(255, 255, 255, 0.50)',
                        'inset 0 -2px 4px rgba(77, 144, 142, 0.06)',
                      ].join(', ')
                    : [
                        '0 4px 16px rgba(77, 144, 142, 0.09)',
                        '0 1px 4px rgba(77, 144, 142, 0.05)',
                        'inset 0 2px 0 rgba(255, 255, 255, 0.45)',
                        'inset 0 -2px 4px rgba(77, 144, 142, 0.05)',
                      ].join(', '),
