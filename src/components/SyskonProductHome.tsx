  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{ position: 'absolute', top: '0%', right: '-25%', width: '130%', height: '135%', zIndex: 0, pointerEvents: 'none' }}
      >
            ...
            return (
              <motion.button
                ...
                style={{
                  ...
                  cursor: 'pointer',
                  border: isDark
                    ? '1px solid hsla(190, 30%, 40%, 0.35)'
                    : '1px solid hsla(170, 30%, 82%, 0.60)',
                  boxShadow: isDark
                    ? [
                        '0 6px 20px hsla(195, 30%, 15%, 0.22)',
                        '0 2px 6px hsla(0, 0%, 0%, 0.10)',
                        'inset 0 1px 0 hsla(190, 35%, 55%, 0.30)',
                      ].join(', ')
                    : [
                        '0 6px 20px hsla(170, 25%, 50%, 0.10)',
                        '0 2px 6px hsla(0, 0%, 0%, 0.04)',
                        'inset 0 2px 1px hsla(170, 40%, 95%, 0.55)',
                        'inset 0 -2px 4px hsla(190, 20%, 30%, 0.06)',
                      ].join(', '),
              ...
              >
                <span
                  style={{
                    ...
                    fontWeight: 400,
                    color: tile.text,
                    textShadow: isDark ? 'none' : '0 1px 4px hsla(170, 30%, 90%, 0.8)',
                  }}
                >
                  {cat.title}
                </span>
            ...
            >
              ...
              <div
                style={{
                  ...
                  inset: 0,
                  borderRadius: '20px',
                  background: 'rgba(77, 144, 142, 0.06)',
                  border: '1px solid rgba(77, 144, 142, 0.10)',
