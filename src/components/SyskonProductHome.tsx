...
const BG = '#1A1C28';
const ACCENT_COLOR = '#D4B878';
const TILE_LIGHT = '#303848';

const ORDERED_TILES = [
  { id: 'sk-vi-blev-syskon', bg: '#303848', sub: 'När familjen växer' },
  { id: 'sk-vi-ar-olika', bg: '#282E3E', sub: 'Att vara egen fast vi hör ihop' },
  { id: 'sk-delat-utrymme', bg: '#222838', sub: 'När allting ska delas' },
  { id: 'sk-er-relation', bg: '#1E2230', sub: 'Nära, svårt och allt däremellan' },
];
    ...
    <div className="min-h-screen relative overflow-hidden" style={{ backgroundColor: BG }}>
      ...
      >
        ...
        <div style={{
          ...
          background: `linear-gradient(to top, ${BG} 0%, ${BG}F2 18%, rgba(26,28,40,0.85) 35%, rgba(37,40,56,0.5) 60%, rgba(48,56,72,0.15) 80%, transparent 100%)`,
          pointerEvents: 'none',
        }} />
      </motion.div>
