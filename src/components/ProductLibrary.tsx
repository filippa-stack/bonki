      ...
      >
        ...
        <span
          style={{
            ...
            padding: '5px 11px',
            borderRadius: 999,
            background: `color-mix(in srgb, ${PRODUCT_ACCENT[productId] ?? '#FFFFFF'} 18%, rgba(255, 255, 255, 0.14))`,
            backdropFilter: 'blur(8px)',
            WebkitBackdropFilter: 'blur(8px)',
            border: `0.5px solid color-mix(in srgb, ${PRODUCT_ACCENT[productId] ?? '#FFFFFF'} 25%, rgba(255, 255, 255, 0.22))`,
            fontFamily: 'Inter, system-ui, sans-serif',
            fontSize: 11.5,
            fontWeight: 600,
