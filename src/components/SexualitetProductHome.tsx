              ...
              <motion.button
                ...
                style={{
                  ...
                  border: isNextCategory
                    ...
                    : isHero ? '1.5px solid rgba(166, 109, 109, 0.18)' : '1px solid rgba(166, 109, 109, 0.08)',
                  boxShadow: [
                    isNextCategory ? `0 0 20px -4px ${SAFFRON}30` : '',
                    isHero
                      ? '0 8px 28px rgba(166, 109, 109, 0.14), 0 3px 8px rgba(166, 109, 109, 0.07), inset 0 2px 0 rgba(255, 255, 255, 0.50), inset 0 -2px 4px rgba(166, 109, 109, 0.06)'
                      : '0 4px 16px rgba(166, 109, 109, 0.09), 0 1px 4px rgba(166, 109, 109, 0.05), inset 0 2px 0 rgba(255, 255, 255, 0.45), inset 0 -2px 4px rgba(166, 109, 109, 0.05)',
                  ].filter(Boolean).join(', '),
